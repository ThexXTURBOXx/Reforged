...
public abstract class EntityCrossbowBolt extends Entity implements IProjectile
{
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(EntityCrossbowBolt.class, DataSerializers.BYTE);
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public EntityCrossbowBolt.PickupStatus pickupStatus;
    ...
    public EntityCrossbowBolt(World worldIn)
    {
        ...
        this.yTile = -1;
        this.zTile = -1;
        this.pickupStatus = EntityCrossbowBolt.PickupStatus.DISALLOWED;
        this.damage = 2.0D;
    ...
    public EntityCrossbowBolt(World worldIn, EntityLivingBase shooter)
    {
        ...
        {
            this.pickupStatus = EntityCrossbowBolt.PickupStatus.ALLOWED;
        }
    }
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        if (entity != null)
        {
            ...
            {
                damagesource = new EntityDamageSourceIndirect("crossbow", raytraceResultIn.entityHit, this).setProjectile();
            }
            else
            {
                damagesource = new EntityDamageSourceIndirect("crossbow", raytraceResultIn.entityHit, this).setProjectile();
            ...
            else
            {
                ...
                {
                    if (this.pickupStatus == EntityCrossbowBolt.PickupStatus.ALLOWED)
                    {
	...
	public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        {
            this.pickupStatus = EntityCrossbowBolt.PickupStatus.getByOrdinal(compound.getByte("pickup"));
        }
        else if (compound.hasKey("player", 99))
        {
            this.pickupStatus = compound.getBoolean("player") ? EntityCrossbowBolt.PickupStatus.ALLOWED : EntityCrossbowBolt.PickupStatus.DISALLOWED;
        }
    }
	...
	public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        ...
        {
            boolean flag = this.pickupStatus == EntityCrossbowBolt.PickupStatus.ALLOWED || this.pickupStatus == EntityCrossbowBolt.PickupStatus.CREATIVE_ONLY && entityIn.capabilities.isCreativeMode;

            if (this.pickupStatus == EntityCrossbowBolt.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getArrowStack()))
            {
                flag = false;
            }
    ...
    public static enum PickupStatus
    {
        ...
        public static EntityCrossbowBolt.PickupStatus getByOrdinal(int ordinal)
        {
