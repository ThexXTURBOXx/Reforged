        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    {
                        damagesource = new EntityDamageSourceIndirect("crossbow", movingobjectposition.entityHit, this).setProjectile();
                    }
                    else
                    {
                        damagesource = new EntityDamageSourceIndirect("crossbow", movingobjectposition.entityHit, shootingEntity).setProjectile();
                    }
