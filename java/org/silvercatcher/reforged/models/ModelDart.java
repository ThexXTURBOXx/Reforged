...
public class ModelDart extends ReforgedModel {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) { 
        ...
        GlStateManager.translate(shapefront.rotationPointX * f5, shapefront.rotationPointY * f5, shapefront.rotationPointZ * f5);
        ...
        GlStateManager.translate(shapebehind.rotationPointX * f5, shapebehind.rotationPointY * f5, shapebehind.rotationPointZ * f5);
        ...
        GlStateManager.translate(shapering.rotationPointX * f5, shapering.rotationPointY * f5, shapering.rotationPointZ * f5);
        ...
        GlStateManager.translate(shapebehind2.rotationPointX * f5, shapebehind2.rotationPointY * f5, shapebehind2.rotationPointZ * f5);
