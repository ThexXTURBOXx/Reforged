...
public class RenderFactoryDart implements IRenderFactory<EntityDart> {
	
	@Override
	public Render<EntityDart> createRenderFor(RenderManager manager) {
		return new RenderDart(manager);
	}
	
	public static class RenderDart extends ReforgedRender {
