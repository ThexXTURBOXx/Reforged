...
public class RendererIronBoomerang extends Render {

	public RendererIronBoomerang(RenderManager renderManager) {
		super(renderManager);
	}
	
	private void renderBoomerang(EntityIronBoomerang entityarrow, double d0, double d1, double d2, float f, float f1) {
	...
	public void doRender(Entity entity, double d0, double d1, double d2,
	 float f, float f1) {
		renderBoomerang((EntityIronBoomerang) entity, d0, d1, d2, f, f1);
	}

	@Override
	protected ResourceLocation getEntityTexture(Entity entity) {
		ResourceLocation BOOMERANG = new ResourceLocation(ReforgedMod.ID, "textures/entity/iron_boomerang.png");
		return BOOMERANG;
	}
}
