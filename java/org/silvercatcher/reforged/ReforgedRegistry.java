...
public class ReforgedRegistry {
	...
	public static void createItems() {
		...
		if(GlobalValues.MUSKET) {
			...
			registrationList.add(DIAMOND_BAYONET_MUSKET = new ItemMusketWithBayonet(ToolMaterial.DIAMOND));
		...
		if(GlobalValues.BATTLEAXE) {
			registrationList.add(DIAMOND_BATTLE_AXE = new ItemBattleAxe(ToolMaterial.DIAMOND));
		}
		...
		if(GlobalValues.BOOMERANG) {
			...
			registrationList.add(DIAMOND_BOOMERANG = new ItemBoomerang(ToolMaterial.DIAMOND));
		}
		...
		if(GlobalValues.SABRE) {
			...
			registrationList.add(DIAMOND_SABER = new ItemSaber(ToolMaterial.DIAMOND));
		}
		...
		if(GlobalValues.KNIFE) {
			...
			registrationList.add(DIAMOND_KNIFE = new ItemKnife(ToolMaterial.DIAMOND));
		}
		...
		if(GlobalValues.KATANA) {
			...
			registrationList.add(DIAMOND_KATANA = new ItemKatana(ToolMaterial.DIAMOND));
		}
