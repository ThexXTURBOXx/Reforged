...
public class EntityDummy extends Entity {
    ...
    public void onUpdate() {
        ...
        final List<Entity> list = this.world.getEntitiesInAABBexcluding(this,
                this.getEntityBoundingBox().expand(0.2, 0.0, 0.2),
    ...
    @Override
    public boolean processInitialInteract(EntityPlayer entityplayer, @Nullable ItemStack itemstack, EnumHand hand) {
        if (itemstack != null) {
